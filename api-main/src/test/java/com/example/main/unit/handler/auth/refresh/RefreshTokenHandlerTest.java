package com.example.main.unit.handler.auth.refresh;
...
public class RefreshTokenHandlerTest extends AbstractUnitTest {
    ...
    public void test_invalidFormat() {
        Exception exception = assertThrows(Exception.class, () -> {
            refreshTokenHandler.handle(new RefreshTokenRequest("abc"), RoleEnum.USER);
        });
    ...
    public void test_notFound() {
        ...
        Exception exception = assertThrows(Exception.class, () -> {
            refreshTokenHandler.handle(new RefreshTokenRequest(UUID.randomUUID().toString()), RoleEnum.USER);
        });
    ...
    public void test_success() {
        ...
        refreshTokenHandler.handle(new RefreshTokenRequest(uuid.toString()), RoleEnum.USER);
